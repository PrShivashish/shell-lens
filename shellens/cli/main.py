...
from shellens.orchestration.orchestrator import Orchestrator
...
def chat(
    ...
    """
    Starts a chat session with the Shell Lens AI.
    """
    if api_key:
    ...
    console = Console()
    console.print("[bold green]Welcome to Shell Lens AI! Type 'exit' to quit.[/bold green]\n")
    ...
    while True:
        try:
            ...
            console.print("\n[bold magenta]Shell Lens AI:[/bold magenta]")
...
def config(
    ...
    """
    Set configuration for Shell Lens AI.
    """
    if groq_key:
